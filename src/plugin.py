...
config.EMC.audlang1                  = ConfigSelection(default = language.lang[language.getActiveLanguage()][1], choices  = langList())
config.EMC.audlang2                  = ConfigSelection(default = language.lang[language.getActiveLanguage()][1], choices  = langList())
config.EMC.audlang3                  = ConfigSelection(default = language.lang[language.getActiveLanguage()][1], choices  = langList())
...
config.EMC.mutagen_install           = NoSave(ConfigYesNo(default = False))
